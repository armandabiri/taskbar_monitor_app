---
id: stacks.flutter.playbooks.performance
genre: playbook
applies_to:
  - flutter
load_mode: reference
...
| Missed build/raster budget     | `<= 0` (critical paths), `<= 1` (non-critical)   | blocking paths include scroll, drag, and tab-switch interactions       |
